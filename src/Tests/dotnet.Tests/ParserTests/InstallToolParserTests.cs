...
namespace Microsoft.DotNet.Tests.ParserTests
{
    public class InstallToolParserTests
    {
        ...
        public void InstallToolParserCanGetGlobalOption()
        {
            ...
            result.GetValueForOption<bool>(ToolAppliedOption.GlobalOptionAliases.First()).Should().Be(true);
        }
        ...
        public void InstallToolParserCanGetLocalOption()
        {
            ...
            result.GetValueForOption<bool>(ToolAppliedOption.LocalOptionAlias).Should().Be(true);
        }
        ...
        public void InstallToolParserCanGetManifestOption()
        {
            ...
            result.GetValueForOption<string>(ToolAppliedOption.ToolManifestOptionAlias).Should().Be("folder/my-manifest.format");
        }
        ...
        public void InstallToolParserCanParseToolPathOption()
        {
            ...
            result.GetValueForOption<string>(ToolAppliedOption.ToolPathOptionAlias).Should().Be(@"C:\Tools");
        }
