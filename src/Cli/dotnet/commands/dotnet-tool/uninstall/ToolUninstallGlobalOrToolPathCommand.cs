...
namespace Microsoft.DotNet.Tools.Tool.Uninstall
{
    ...
    internal class ToolUninstallGlobalOrToolPathCommand : CommandBase
    {
        ...
        {
            var global = _parseResult.GetValueForOption<bool>(ToolAppliedOption.GlobalOptionAliases.First());
            var toolPath = _parseResult.GetValueForOption<string>(ToolAppliedOption.ToolPathOptionAlias);
